  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <Card className="border-none shadow-md">
          <CardHeader>
            <CardTitle className="text-lg font-medium">Chi tiết Hiệu suất Đầu tư (TWRR vs VN-Index)</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-4 p-4 bg-slate-50 rounded-xl border border-blue-100 text-xs text-slate-600 leading-relaxed">
        ...
        {/* Net Worth History Chart (Moved here) */}
        <Card className="border-none shadow-md">
          <CardHeader>
